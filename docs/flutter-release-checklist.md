...
Expected artifacts for version `0.1.9`:

- `dist/flutter-release/linux/chronopic-flutter-linux-x64-0.1.9.tar.gz`
- `dist/flutter-release/linux/chronopic-flutter-linux-x64-0.1.9.tar.gz.sha256`
