...
Expected artifacts for version `0.1.5`:

- `dist/flutter-release/linux/chronopic-flutter-linux-x64-0.1.5.tar.gz`
- `dist/flutter-release/linux/chronopic-flutter-linux-x64-0.1.5.tar.gz.sha256`
