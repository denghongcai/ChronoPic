...
Expected artifacts for version `0.1.8`:

- `dist/flutter-release/linux/chronopic-flutter-linux-x64-0.1.8.tar.gz`
- `dist/flutter-release/linux/chronopic-flutter-linux-x64-0.1.8.tar.gz.sha256`
