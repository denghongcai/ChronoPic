...
void main() {
  test(
    'fixture adapter lists, stats, reads, and reports missing assets',
    () async {
      ...
      expect(
        await source.listMissingAssetIds(['asset-1', 'asset-2', 'asset-3']),
        ['asset-2', 'asset-3'],
      );
    },
  );
  ...
  test(
    ...
    () async {
      ...
      image.deleteSync();
      expect(await source.listMissingAssetIds([image.absolute.path]), [
        image.absolute.path,
      ]);
    },
  );
